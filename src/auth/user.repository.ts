...
const usersEmails = ['valdar@opennetworking.org'];//['bill@opennetworking.org', 'ain@opennetworking.org', 'sean@opennetworking.org', 'zdw@opennetworking.org', 'valdar@opennetworking.org'];
const supervisor = ['valdar@opennetworking.org'];//['ain@opennetworking.org', 'bill@opennetworking.org', 'ain@opennetworking.org', 'bill@opennetworking.org' , 'valdar@opennetworking.org'];
const userNames = [['Valdar', 'Rudman']];//[['William', 'Snow'], ['Ain', 'Indermitte'], ['Sean', 'Condon'], ['Zack', 'Williams'], ['Valdar', 'Rudman']];
