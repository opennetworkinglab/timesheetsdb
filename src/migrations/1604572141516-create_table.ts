...
export class createTable1604572141516 implements MigrationInterface {
    name = 'createTable1604572141516'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "onf_days" ("date" date NOT NULL, "weekId" integer, CONSTRAINT "PK_e60cf743dc9cd53a0a8446366bf" PRIMARY KEY ("date"))`);
        ...
        await queryRunner.query(`ALTER TABLE "onf_days" ADD CONSTRAINT "FK_5671d00deb038e3204d6ee9ea3d" FOREIGN KEY ("weekId") REFERENCES "weeks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "onf_days" DROP CONSTRAINT "FK_5671d00deb038e3204d6ee9ea3d"`);
        ...
        await queryRunner.query(`DROP TABLE "onf_days"`);
